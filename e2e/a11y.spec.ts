...
const ROUTES = ["/", "/resources", "/academic-help", "/discounts", "/amenities", "/clubs", "/opportunities", "/report", "/updates", "/sg"];
...
test.describe("WCAG AA", () => {
  const ROUTES = ["/", "/resources", "/academic-help", "/discounts", "/amenities", "/clubs", "/opportunities", "/report", "/updates", "/sg", "/admin"];
